    ...
    <table class="table table-xs table-zebra">
        <thead>
            <tr class="text-center text-lg text-primary">
                ...
                <th title={$t("stuff.common.likes")}><i class="bi bi-heart-fill"></i></th>
                <th title={$t("stuff.common.reposts")}><i class="bi bi-repeat"></i></th>
                <th title={$t("stuff.common.replies")}><i class="bi bi-chat-square-text-fill"></i></th>
